...
class JLoader
{
	 ...
	 * @since   1.5
	 */
	// RAT (27.01.15) change definition to public static to be able to register with spl_autoload_register()
...
// RAT (27.01.15) register the load class function with spl_autoload_register() as it should be done
