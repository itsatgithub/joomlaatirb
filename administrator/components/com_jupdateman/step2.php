...
?>
<p>The file '<?php echo $file ?>' has been downloaded from <a
	href="<?php echo $url ?>" target="_blank"><?php echo $url ?></a>.</p>
<p>If you are certain you want to use this method, <a
	href="index.php?option=com_jupdateman&task=step3">you can proceed with
the install &gt;&gt;&gt;</a></p>
