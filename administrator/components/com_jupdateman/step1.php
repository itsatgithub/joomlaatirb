...
?>
<ul>
	<li><a href="index.php?option=com_jupdateman&task=step2&target=full">Full
	...
	?></li>
	<?php if($patchdetails) { ?>
	<li><a href="index.php?option=com_jupdateman&task=step2&target=patch">Patch
...
<p style="font-weight: bold">Note: You are using cached update mode. You
will need to upload the update files to your temporary directory before
continuing.</p>
