...
class JHTMLIrbtoolsInstallHelper
{
	function getVersionLocal()
	{
      ...
      function getVersionRemote()
      {
          ...
          ob_start();
          // This url should be taken from the configuration parameters
          $url = 'https://joomlaatirb.googlecode.com/svn/trunk/administrator/components/com_irbtools/irbtools.xml';
