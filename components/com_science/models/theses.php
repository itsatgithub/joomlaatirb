...
class ScienceModelTheses extends JModel
{
	...
	function _buildQueryWhere()
	{
		...
		if ($filter_search = trim($filter_search))
		{
			...
			$where[] = '('
			. ' t.id LIKE "%' . $filter_search . '%"'
			. ' OR LOWER(t.title) LIKE "%' . $filter_search . '%"'
			. ' OR LOWER(t.author) LIKE "%' . $filter_search . '%"'
			. ' OR LOWER(t.university) LIKE "%' . $filter_search . '%"'
			. ' OR LOWER(t.year) LIKE "%' . $filter_search . '%"'
			. ')'
			;
		}
	...
	function _buildQueryOrderBy()
	{
		...
		$orders = array('t.id', 't.title', 't.author', 't.university', 't.year');
